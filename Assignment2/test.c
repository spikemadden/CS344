...
void create_files(char* number, char* temp, char* directory, FILE* file_pointer, char* room_names[], struct room* setup) {
...
int main () {
	...
	create_files(number, temp, directory, file_pointer, room_names, setup);
